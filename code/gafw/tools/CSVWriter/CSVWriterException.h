...
{
    class CSVWriterException: public std::exception 
    {
        std::string * whatReturn; 
        std::string reason;
        std::string function;
    public:
        CSVWriterException(std::string function,std::string reason) throw();
        CSVWriterException(const CSVWriterException& orig) throw();
        ~CSVWriterException() throw();
