/* Real.h:  Definition of the Real operator class 
 *      
...
namespace GAFW { namespace GPU
{
    ...
    {
        class Real: public GAFW::GPU::GPUArrayOperator {
        private:
//            Real(const Real& orig):GPUArrayOperator(NULL) {};  
            unsigned int calculateArraySize(GAFW::ArrayDimensions& d, GAFW::GeneralImplimentation::StoreType  &type);
        public:
            Real(GAFW::GPU::GPUFactory * factory,std::string nickname);
            ~Real();
