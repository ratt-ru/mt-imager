/* ZeroPad.h:  Definition of the ZeroPad operator class 
 *      
...
namespace GAFW { namespace GPU 
{
    ...
    {
        class ZeroPad: public GAFW::GPU::GPUArrayOperator {
        private:
            unsigned int calculateArraySize(GAFW::ArrayDimensions& d, GAFW::GeneralImplimentation::StoreType  &type);
        public:
            ZeroPad(GAFW::GPU::GPUFactory * factory,std::string nickname);
            ~ZeroPad();
