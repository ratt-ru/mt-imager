/* ZeroToCentre2DShift.cpp:  C++ implementation of the ZeroToCentre2DShift operator 
 *      
...
ZeroToCentre2DShift::ZeroToCentre2DShift(GAFW::GPU::GPUFactory * factory,std::string nickname):GPUArrayOperator(factory,nickname,string("Operator::FFT2DShift"))
{


}
ZeroToCentre2DShift::~ZeroToCentre2DShift() {
}

void ZeroToCentre2DShift::validate()
{
