/* Real.cpp:  C++ implementation of the Real operator 
 *      
...
Real::Real(GAFW::GPU::GPUFactory * factory,std::string nickname) : GPUArrayOperator(factory,nickname,string("Operator::Real"))
{
...
void Real::validate(){
   ...
   //No of inputs
    ...
    if (this->inputs[0]->getType()!=complex_float) throw ValidationException("Input is expected to be of type complex_float")
