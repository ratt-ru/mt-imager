/* ZeroToCentre2DShift.h:  Definition of the ZeroToCorner2DShift operator class 
 *      
...
#ifndef __ZEROTOCENTRE2DSHIFT_H__
#define	__ZEROTOCENTRE2DSHIFT_H__
//Operator shifts 0 component to centre of spectrum
namespace GAFW { namespace GPU 
{
    namespace StandardOperators
    {
        class ZeroToCentre2DShift: public GAFW::GPU::GPUArrayOperator {
        private:
//            FFT2DShift(const FFT2DShift& orig):GPUArrayOperator(NULL) {};  
        ...
        public:
            ZeroToCentre2DShift(GAFW::GPU::GPUFactory * factory,std::string nickname);
            ~ZeroToCentre2DShift();
